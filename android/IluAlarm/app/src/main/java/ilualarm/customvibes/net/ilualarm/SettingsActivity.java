...
import ilualarm.customvibes.net.ilualarm.fragments.AppCompatPreferenceActivity;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean inFragment = false;
    ...
    public static class DevicePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("device_url"));
            bindPreferenceSummaryToValue(findPreference("device_port"));
        }
